...
--
CREATE DATABASE IF NOT EXISTS `clothingshop` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `clothingshop`;
...
(1, 'admin', 'admin@gmail.com', '124', 0, 1641509311),
(5, 'admin1', '', '25f9e794323b453885f5181f1b624d0b', 0, 0);
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  KEY `fk_size` (`size_id`) USING BTREE,
  KEY `fk_transation` (`transaction_id`)
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `image_list` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS `sizedetail`;
CREATE TABLE IF NOT EXISTS `sizedetail` (
  `id` int NOT NULL AUTO_INCREMENT,
  `product_id` int NOT NULL,
  `size_id` varchar(11) NOT NULL,
  `quantity` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_sizes` (`size_id`),
  KEY `fk_sizedelta_product` (`product_id`)
